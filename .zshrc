if [[ $(ps --no-header -p $PPID -o comm) =~ '^yakuake|konsole|alacritty|tmux' ]]; then
...
zplug "romkatv/powerlevel10k", use:powerlevel9k.zsh-theme, as:theme, depth:1
...
zplug "pkulev/zsh-rustup-completion",              if:"(( $+commands[rustup] ))"
